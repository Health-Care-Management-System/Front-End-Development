...
@Component({
  selector: 'app-hospitalsearch-fi',
  templateUrl: './hospitalsearch-fi.component.html',
  styleUrls: ['./hospitalsearch-fi.component.css']
})
export class HospitalsearchFiComponent implements OnInit {
